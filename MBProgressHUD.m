...
//        self.labelFont = [UIFont boldSystemFontOfSize:LABELFONTSIZE];
        ...
        self.labelFont = [UIFont regularWithSize:LABELFONTSIZE];
        
        self.detailsLabelFont = [UIFont regularWithSize:LABELFONTSIZE];//[UIFont boldSystemFontOfSize:LABELDETAILSFONTSIZE];
        self.xOffset = 0.0;
        self.yOffset = 0.0;
		self.graceTime = 0.0;
...
//        CGSize dims = [self.labelText sizeWithFont:self.labelFont];
        ...
        if ([Utility isiOSVersion7]) {
            dims = [self.labelText sizeWithAttributes:
                    @{NSFontAttributeName:
                          self.labelFont}];
        }
        else{
